define({
  root: ({
    ...
    selectFeatures: "<img style='cursor:pointer; margin-top: 3px;margin-right: 3px;margin-left:-5px;' height='16px' width='16px' src='images/i_searchgraphical.png'>Spatial Search",
    selectByAttribute: "<img style='cursor:pointer; margin-top: 3px;margin-right: 5px;margin-left:-5px;' height='16px' width='16px' src='images/select_features2.png'>Text Search",
    results: "<img style='cursor:pointer; margin-top: 3px;margin-right: 7px;margin-left:-5px;' height='16px' width='16px' src='images/i_table.png'>Results",
    resultsWord: "Results",
    searchLayer: "Search layer",
    searchType: "Search alias",
    selectFeaturesBy: "Select features by",
    selectSpatial: "<img style='cursor:pointer; margin-top: 3px;margin-right: 3px;margin-left:-5px;' height='16px' width='16px' src='images/i_clock.png'>Filter by Time",
    selectFields: "<img style='cursor:pointer; margin-top: 3px;margin-right: 3px;margin-left:-5px;' height='16px' width='16px' src='images/cal.gif'>Choose Fields",
    search: "Search",
    clear: "Clear",
